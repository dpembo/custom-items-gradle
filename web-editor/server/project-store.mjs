...
export class ProjectStore {
  ...
  async initialize() {
    ...
    try {
      ...
      if (JSON.stringify(this.config.validation.allowedMaterials) === JSON.stringify(previousMaterials) || !this.config.validation.allowedMaterials.includes('TRIDENT')) {
